<!-- PAYOFF -->
<div class="h-svh w-full snap-center p-1 lg:p-12" id="people-beyond-ai">
	<div
	...
	>
		<div class="relative">
			<div class="relative z-100 flex h-full w-full flex-col items-center">
				<h1 class="mb-4 p-8 px-12 text-center text-4xl font-medium lg:p-0 lg:px-0">
					People Beyond AI
				</h1>
			...
			<span
				class="absolute -top-[25%] left-[50%] z-10 flex size-120 -translate-x-[50%] lg:-translate-x-[50%] lg:-translate-y-[25%]"
			>
				<span
